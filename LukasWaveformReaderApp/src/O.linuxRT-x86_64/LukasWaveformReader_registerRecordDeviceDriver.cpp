...
/* Generated from ../O.Common/LukasWaveformReader.dbd */
...
epicsShareExtern drvet *pvar_drvet_drvAsyn, *pvar_drvet_yamlLoaderDriver;

static const char *driverSupportNames[] = {
    "drvAsyn", "yamlLoaderDriver"};

static struct drvet *drvsl[] = {
    pvar_drvet_drvAsyn,
    pvar_drvet_yamlLoaderDriver};
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_maxBeamLossLocationRegister, pvar_func_printHelpRegister,
...
int LukasWaveformReader_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    pvar_func_drvYamlDownloaderRegister();
    pvar_func_fourierTransformRegister();
    pvar_func_maxBeamLossLocationRegister();
    pvar_func_printHelpRegister();
    pvar_func_rsrvRegistrar();
    pvar_func_syncInitialize();
    pvar_func_tsInitialize();
    pvar_func_waveformReaderRegister();
    pvar_func_waveformStatusRegister();
    pvar_func_waveformStreamRegister();
    pvar_func_yamlLoaderRegister();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* LukasWaveformReader_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"LukasWaveformReader_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(LukasWaveformReader_registerRecordDeviceDriver(*iocshPpdbbase));
}
